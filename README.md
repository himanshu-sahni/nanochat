...
2. Run the initial setup (environment, uv, wandb, data prep) but do not retrain the tokenizer!! You can do this simply by running the command:
...
![forward vs reverse kl](dev/forward-reverse-kl.png)
